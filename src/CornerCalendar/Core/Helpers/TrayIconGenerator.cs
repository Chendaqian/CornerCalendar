...
public static class TrayIconGenerator
{
    ...
    public static Icon Generate(int day)
    {
        ...
        // 绘制圆形背景
        using SolidBrush bgBrush = new SolidBrush(Color.FromArgb(37, 37, 38)); // 深色背景
        ...
        using Font font = new Font("Segoe UI", text.Length > 1 ? 11f : 14f, System.Drawing.FontStyle.Bold);
